...
const data = {
  '1': {
    ...
    category: 'coin',
    description:
      'Bitcoin (BTC) is a cryptocurrency launched in 2010. Users are able to generate BTC through the process of mining. Bitcoin has a current supply of 19,758,003. The last known price of Bitcoin is 63,352.30767246 USD and is up 0.18 over the last 24 hours. It is currently trading on 11714 active market(s) with $34,179,239,951.99 traded over the last 24 hours. More information can be found at https://bitcoin.org/.',
    slug: 'bitcoin',
