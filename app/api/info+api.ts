...
export async function GET(request: Request) {
  ...
  // const ids = url.searchParams.get('ids') || '1,1027,825,1839,5426';
...
const data = {
  '1': {
    ...
    category: 'coin',
    description:
      'Bitcoin (BTC) is a cryptocurrency launched in 2010. Users are able to generate BTC through the process of mining. Bitcoin has a current supply of 19,758,371. The last known price of Bitcoin is 63,257.84396956 USD and is down -0.36 over the last 24 hours. It is currently trading on 11714 active market(s) with $26,426,508,482.47 traded over the last 24 hours. More information can be found at https://bitcoin.org/.',
    slug: 'bitcoin',
  ...
  '825': {
    ...
    category: 'token',
    description:
      'Tether USDt (USDT) is a cryptocurrency and operates on the Ethereum platform. Tether USDt has a current supply of 121,386,817,750.8436 with 119,243,573,831.05162 in circulation. The last known price of Tether USDt is 1.00036488 USD and is up 0.01 over the last 24 hours. It is currently trading on 98481 active market(s) with $52,539,711,720.84 traded over the last 24 hours. More information can be found at https://tether.to.',
    slug: 'tether',
  ...
  '1027': {
    ...
    category: 'coin',
    description:
      'Ethereum (ETH) is a cryptocurrency . Ethereum has a current supply of 120,362,207.96313831. The last known price of Ethereum is 2,617.15414486 USD and is down -2.69 over the last 24 hours. It is currently trading on 9339 active market(s) with $16,264,272,884.79 traded over the last 24 hours. More information can be found at https://www.ethereum.org/.',
    slug: 'ethereum',
  ...
  '1839': {
    ...
    category: 'coin',
    description:
      'BNB (BNB) is a cryptocurrency . BNB has a current supply of 145,933,405.68404746. The last known price of BNB is 606.04139155 USD and is up 0.05 over the last 24 hours. It is currently trading on 2239 active market(s) with $2,082,640,381.10 traded over the last 24 hours. More information can be found at https://bnbchain.org/en.',
    slug: 'bnb',
  ...
  '5426': {
    ...
    category: 'coin',
    description:
      'Solana (SOL) is a cryptocurrency launched in 2020. Solana has a current supply of 585,231,437.6382508 with 468,729,857.87815875 in circulation. The last known price of Solana is 145.58884117 USD and is up 0.91 over the last 24 hours. It is currently trading on 738 active market(s) with $2,320,405,274.94 traded over the last 24 hours. More information can be found at https://solana.com.',
    slug: 'solana',
